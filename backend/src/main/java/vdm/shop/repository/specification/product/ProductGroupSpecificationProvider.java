...
@Component
public class ProductGroupSpecificationProvider implements SpecificationProvider<Product> {
    private static final String KEY = "productGroup";
    ...
    public Specification<Product> getSpecification(String[] params) {
        ...
        return (root, query, cb) ->
                root.get("productGroup").get("id").in(ids);
    }
}
